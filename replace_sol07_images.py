...
ai_img = '<img src="camera-ai.jpg" alt="AI Passenger Counting System">'
html = html.replace(ai_placeholder, ai_img)
...
interior_img = '<img src="camera-interior.jpg" alt="Interior Monitoring Camera">'
html = html.replace(interior_placeholder, interior_img)
...
exterior_img = '<img src="camera-exterior.jpg" alt="Exterior Monitoring Camera">'
html = html.replace(exterior_placeholder, exterior_img)

with open("solutions.html", "w", encoding="utf-8") as f:
    f.write(html)

print("Replaced placeholders with real images.")
